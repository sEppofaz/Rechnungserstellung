...
- **`_Adressen.xlsx` Spalte 8 = Anrede (ab 2026-06-12):** Schema: Name | Straße | PLZ | Ort | Straße validiert | PLZ+Ort validiert | Hinzugefügt | **Anrede** (Firma/Herr/Frau). Bestehende Zeilen haben leere Spalte 8 → OCR-Fallback aus Register, manuell im Adressen-Modal nachpflegbar. `add_to_address_excel()` schreibt Anrede immer in Spalte 8.
